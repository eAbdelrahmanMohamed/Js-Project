...
let cart = [{
    ...
    price: "14.56",
    Quantity: 1,
    //user: JSON.parse(localStorage.customers)[0].email.split("@")[0],
}];
...
//        .map((product) => {
//            //let adds = product.class;

//            //adds.addEventListener("click", function() { alert("done") });
...
//          <span>Wishlist</span>
//        </a>
//        <a class='${product.class} btn-cart flex-align-center gap-1' onclick='AddToCart("${product.id}","${product.name}","${product.price}")'>
